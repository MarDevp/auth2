...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .requestMatchers("/api/objectif/**").permitAll()
                ...
                .requestMatchers("/api/resultat/**").permitAll()
                ...
                .requestMatchers("/api/indicateur/**").permitAll()
                ...
                .requestMatchers("/api/activite/**").permitAll()
                ...
                .requestMatchers("/api/indicateur_objectif_projet/**").permitAll()
                .requestMatchers("/api/indicateur_resultat_projet/**").permitAll()
                .requestMatchers("/api/indicateurPlanById_indicateur/**").permitAll()
                .requestMatchers("/api/updateIndicateurDPValeur_reele/**").permitAll()
                .requestMatchers("/api/resultat_projet/**").permitAll()
                .requestMatchers("/api/indicateur_objective_projet/**").permitAll()
                .requestMatchers("/api/indicateurByObjectifId/**").permitAll()
                .requestMatchers("/api/count_objectif_projet/**").permitAll()
                .requestMatchers("/api/count_resultat_projet/**").permitAll()
                .requestMatchers("/api/countIndicateurByObjectifId/**").permitAll()
                .requestMatchers("/api/resultat_objectif/**").permitAll()
                .requestMatchers("/api/count_resultat_objectif/**").permitAll()
                .requestMatchers("/api/countIndicateurByProjetId/**").permitAll()
